...
@section('content')
    <div class="container mt-5">
        ...
        <form action="{{ route('faq-questions.update', $question->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <textarea name="answer" id="answer" class="form-control" rows="4" required>{{ $question->answer }}</textarea>
            </div>
